...
public class MenuAdmin extends javax.swing.JFrame implements ActionListener
{
    ...
    private void initComponents() {
        ...
        BotonUsuariosMenuAdmin.addActionListener(new ActionListener() {
        ...
        BotonEmpresasMenuAdmin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
    ...
    private void BotonUsuariosMenuAdminActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BotonUsuariosMenuAdminActionPerformed
    ...
    private void BotonEmpresasMenuAdminActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BotonEmpresasMenuAdminActionPerformed
        // TODO add your handling code here:
