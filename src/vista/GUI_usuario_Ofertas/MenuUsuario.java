...
public class MenuUsuario extends javax.swing.JFrame implements ActionListener
{
    ...
    private void initComponents() {
        ...
        BotonMisOfertasMenuUsuario.addActionListener(new ActionListener() {
        ...
        BotonSalirMenuUsuario.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        BotonEmpresasMenuUsuario.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        BotonEliminarCuentaMenuUsuario.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
    ...
    private void BotonMisOfertasMenuUsuarioActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BotonMisOfertasMenuUsuarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BotonMisOfertasMenuUsuarioActionPerformed

    private void BotonSalirMenuUsuarioActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BotonSalirMenuUsuarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BotonSalirMenuUsuarioActionPerformed

    private void BotonEmpresasMenuUsuarioActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BotonEmpresasMenuUsuarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BotonEmpresasMenuUsuarioActionPerformed

    private void BotonEliminarCuentaMenuUsuarioActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BotonEliminarCuentaMenuUsuarioActionPerformed
        // TODO add your handling code here:
