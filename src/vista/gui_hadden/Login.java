...
public class Login extends javax.swing.JFrame implements ActionListener
{
    ...
    private void initComponents() {
        ...
        BotonIngresarLogin.addActionListener(new ActionListener() {
        ...
        BotonRegistrarLogin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
    ...
    private void BotonIngresarLoginActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BotonIngresarLoginActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BotonIngresarLoginActionPerformed

    private void BotonSalirLoginActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BotonSalirLoginActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BotonSalirLoginActionPerformed

    private void BotonRegistrarLoginActionPerformed(ActionEvent evt) {//GEN-FIRST:event_BotonRegistrarLoginActionPerformed
        // TODO add your handling code here:
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==this.BotonIngresarLogin){
            try {
                InputStream response = new URL("http://localhost:8080/controller/login/"+this.CampoTextoUsuarioLogin.getText()+"/"+this.CampoTextoPasswordLogin.getText()).openStream();
                this.key = IOUtils.toString(response,"UTF-8");
                response.available();

                response = new URL("http://localhost:8080/controller/getTipo/"+key).openStream();
                String tipo = IOUtils.toString(response,"UTF-8");
                response.close();
